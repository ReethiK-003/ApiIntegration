...
//
//	public AccountService(AccountRepo accountRepo, UserService userService, MailService mailService,
//			TokenService tokenService, ProjectService projectService, EntityManager entityManager) {
...
//	}
	...
	public Account validateAndJoinUser(String req, User user)
		...
		System.out.println("User added in account !!");
	...
	public User updateUser(UpdateUserRequest request, User mainUser)
		...
		System.out.println("Condition :  " + user.getAccount().getId() + mainUser.getAccount().getId() + " "
				+ (user.getAccount().getId().equals(mainUser.getAccount().getId())));
